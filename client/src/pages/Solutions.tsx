  ...
  const solutions = [
    {
      ...
      description: "Perfect for startups and small businesses looking to streamline operations",
      icon: <Users className="w-8 h-8 text-blue-600" />,
      features: ["Up to 10 users", "Basic integrations", "Essential analytics"],
      href: "/solutions/small-teams"
    },
    {
      title: "For Enterprise",
      description: "Comprehensive solutions for large organizations with complex needs",
      icon: <Building2 className="w-8 h-8 text-purple-600" />,
      features: ["Unlimited users", "Advanced integrations", "Custom analytics"],
      href: "/solutions/enterprise"
    },
    {
      title: "For All Teams",
      description: "Cross-functional solutions that work for any team size or structure",
      icon: <Target className="w-8 h-8 text-green-600" />,
      features: ["Flexible scaling", "All integrations", "Real-time insights"],
      href: "/solutions/all-teams"
    }
  ];
      ...
      <section className="px-8 py-20 bg-gradient-to-b from-blue-50 to-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-600 mb-12 max-w-2xl mx-auto">
            Whether you're a startup, enterprise, or somewhere in between, 
            we have the perfect solution to transform your business intelligence.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-3 gap-8">
            {solutions.map((solution, index) => (
              <Card key={index} className="border border-gray-200 hover:shadow-lg transition-shadow cursor-pointer" onClick={() => setLocation(solution.href)}>
