...
export default function SignIn() {
  ...
  return (
    <div className="min-h-screen flex">
      ...
      <header className="absolute top-0 left-0 right-0 z-10 bg-white/95 backdrop-blur-sm border-b border-gray-100">
        <div className="flex items-center justify-between px-8 py-5">
          ...
          <div className="flex items-center space-x-4">
            <Button variant="ghost" className="text-gray-700 hover:text-blue-600 hover:bg-blue-50 transition-colors duration-200" onClick={() => setLocation("/sign-up")}>Sign up</Button>
      ...
      <div className="flex-1 bg-gradient-to-br from-blue-900 via-blue-800 to-purple-900 flex flex-col justify-center items-center px-12 pt-20">
        <div className="max-w-md text-center">
          <h1 className="text-5xl font-bold text-white mb-6 leading-tight">
            Welcome back to
            <span className="text-lime-400 block">Oraclio</span>
          </h1>
          
          <p className="text-blue-100 text-lg mb-8 leading-relaxed">
            Continue your AI-powered business intelligence journey and unlock new insights from your data.
          </p>
