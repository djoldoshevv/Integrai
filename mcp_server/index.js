...
// test
server.tool("test", function () { return __awaiter(void 0, void 0, void 0, function () {
...
server.registerResource("excel", new mcp_js_1.ResourceTemplate("excel://{name}", { list: undefined }), {
    ...
    return __generator(this, function (_c) {
        return [2 /*return*/, ({
                contents: [{
                        uri: uri.href,
                        text: "Excel file for ".concat(name)
                    }]
            })];
    });
}); });
